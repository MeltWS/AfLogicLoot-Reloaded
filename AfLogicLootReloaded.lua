-----------------------------------------------------------------------------------------------
-- Client Lua Script for AfLogicLootReloaded
...
-----------------------------------------------------------------------------------------------
-- AfLogicLootReloaded Module Definition
-----------------------------------------------------------------------------------------------
local AfLogicLootReloaded = {} 
local L = Apollo.GetPackage("Gemini:Locale-1.0").tPackage:GetLocale("AfLogicLootReloaded", true)
...
function AfLogicLootReloaded:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self 
...
function AfLogicLootReloaded:Init()
	local bHasConfigureFunction = true
	local strConfigureButtonText = "afLogicLoot Reloaded"
	local tDependencies = {
		-- "UnitOrPackageName",
	}
...
-----------------------------------------------------------------------------------------------
-- AfLogicLootReloaded OnLoad
-----------------------------------------------------------------------------------------------

function AfLogicLootReloaded:OnLoad()
    -- load our form file
	self.xmlDoc = XmlDoc.CreateFromFile("AfLogicLootReloaded.xml")
	self.xmlDoc:RegisterCallback("OnDocLoaded", self)
	Apollo.LoadSprites("AfLogicLootReloadedSprites.xml", "AfLogicLootReloadedSprites")
end


-----------------------------------------------------------------------------------------------
-- AfLogicLootReloaded OnDocLoaded
-----------------------------------------------------------------------------------------------

function AfLogicLootReloaded:OnDocLoaded()

	if self.xmlDoc ~= nil and self.xmlDoc:IsLoaded() then
	    self.wndMain = Apollo.LoadForm(self.xmlDoc, "AfLogicLootReloadedForm", nil, self)
		...
		Apollo.RegisterSlashCommand("afloot", "OnAfLogicLootReloadedOn", self)
...
-----------------------------------------------------------------------------------------------
-- AfLogicLootReloaded Functions
-----------------------------------------------------------------------------------------------

function AfLogicLootReloaded:RecursiveTranslation(wndItem)
...
function AfLogicLootReloaded:LocalizeWindow()
	local i
...
function AfLogicLootReloaded:OnAfLogicLootReloadedOn(strCommand, strParam)
...
function AfLogicLootReloaded:DelayedGuildCheck()
...
function AfLogicLootReloaded:UpdateGuildListSource(uGuild)
	uGuild:RequestMembers()
end


function AfLogicLootReloaded:UpdateGuildList(uGuild, roster)
...
function AfLogicLootReloaded:OnConfigure()
	self.wndMain:Invoke()
	self:SettingsToGUI()
end


function AfLogicLootReloaded:statistic()
...
function AfLogicLootReloaded:ChoseProfile()
...
function AfLogicLootReloaded:RegExSafe(strMessage)
...
function AfLogicLootReloaded:SettingsToGUI()
...
function AfLogicLootReloaded:GUIToSettings()
...
function AfLogicLootReloaded:RefreshProfileSelectorDisplay()
	local i
...
function AfLogicLootReloaded:CheckProfileSelector()
	local i
	for i = 1, 8, 1 do
...
function AfLogicLootReloaded:CopyTable(obj, seen)
...
function AfLogicLootReloaded:OnSave(eType)
...
function AfLogicLootReloaded:OnRestore(eType, tSavedData)
	if eType == GameLib.CodeEnumAddonSaveLevel.Account then
...
function AfLogicLootReloaded:OnLootRollUpdate()
...
function AfLogicLootReloaded:OnLootRollWon(itemWon, strWinnerName, bNeed)
	local uMe = GameLib.GetPlayerUnit()
	local sMe = ""
	if uMe then
		sMe = uMe:GetName()
...
function AfLogicLootReloaded:PostLootMessage(uItem, iChoice, strCategory)
...
function AfLogicLootReloaded:CheckForAutoAction(LootListEntry)
...
function AfLogicLootReloaded:DoLootAction(LootID, action)
...
function AfLogicLootReloaded:CloseOrgLootWindow(LootID)
...
function AfLogicLootReloaded:analyze(item)
...
function AfLogicLootReloaded:OnTimer()
	self:ChoseProfile()
end


function AfLogicLootReloaded:log(strMeldung)
...
function AfLogicLootReloaded:SetStatus(bActive)
	local wndToggleButton1 = self.wndMain:FindChild("btnToggleButton1")
	local wndToggleButton2 = self.wndMain:FindChild("btnToggleButton2")
...
function AfLogicLootReloaded:AddProfile()
...
function AfLogicLootReloaded:LoadProfiles()
...
function AfLogicLootReloaded:HudLog(strMessage)
...
function AfLogicLootReloaded:OnHudLogTimer()
...
function AfLogicLootReloaded:NextHudLog()
...
-----------------------------------------------------------------------------------------------
-- AfLogicLootReloadedForm Functions
-----------------------------------------------------------------------------------------------

function AfLogicLootReloaded:OnOK()
	self:GUIToSettings()
	self.wndMain:Close()
end


function AfLogicLootReloaded:OnCancel()
	self.wndMain:Close()
end


function AfLogicLootReloaded:OnTabSelected(wndHandler, wndControl, eMouseButton)
	local iTab = self.wndMain:GetRadioSel("tabs")
	self:SwitchToTab(iTab)
end


function AfLogicLootReloaded:SwitchToTab(iTab)
...
function AfLogicLootReloaded:ToggleStatus(wndHandler, wndControl, eMouseButton)
	self:SetStatus(not self.settings.active)
end


function AfLogicLootReloaded:OnAddProfile(wndHandler, wndControl, eMouseButton)
	self:AddProfile()
end


function AfLogicLootReloaded:OnProfileCombobox(wndHandler, wndControl, eMouseButton)
	local wndComboboxPopup = self.wndMain:FindChild("frm_combobox_popup")
	wndComboboxPopup:Show(wndComboboxPopup:IsShown() == false)
end


function AfLogicLootReloaded:OnAssignProfile(wndHandler, wndControl, eMouseButton)
...
function AfLogicLootReloaded:OnComboboxEntry(wndHandler, wndControl, eMouseButton)
	local wndComboboxPopup = self.wndMain:FindChild("frm_combobox_popup")
...
function AfLogicLootReloaded:OnDeleteProfile(wndHandler, wndControl, eMouseButton)
...
-----------------------------------------------------------------------------------------------
-- AfLogicLootReloaded Instance
-----------------------------------------------------------------------------------------------
local AfLogicLootReloadedInst = AfLogicLootReloaded:new()
AfLogicLootReloadedInst:Init()
